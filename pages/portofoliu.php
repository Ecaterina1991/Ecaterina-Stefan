...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="description" content="Forma incipienta a portofoliului meu" />
    <meta
      name="keywords"
      content="Ecaterina Stefan, portofoliu, proiecte, Web-Development, UX-Design, logo"
    />
  ...
  <body>
    ...
    <div class="portofolio-wrapper">
      <section class="portofolio-sectiune">
        <div>
          <h2 class="titlu_portofoliu">Portofoliu de Web Developer</h2>
          ...
          <ul class="lista_portofoliu">
            <li>
              ...
              produselor printate 3D (ca parte componentă a programului de
              studiu ”Learn PHP 2023”).
            </li>
            ...
            <li>
              ...
              leaflet. Tastați pe ecran locurile preferate pe care le-ați găsit
              pentru pictură. Urmează să îmbunătățesc aplicația și funcțiile
              acesteia.
            </li>
            <li>
              <a
            ...
            <li>
              ...
              ajutorul unui API, ca și temă pentru acasă în cadrul cursului
            ...
            <li>
              ...
              fost tema mea pentru acasă pentru a-mi dovedi cunoștințele HTML și
              CSS, dobândite în cadrul cursului SkillBrain Front End Developer.
              Astfel am lucrat pentru prima dată la un nivel profesionist,
              folosindu-mă de cunoștințele mele.
            </li>
            <li>
              <a
              ...
              HTML și CSS (proiect SkillBrain).
            </li>
            <li>
              <a
            ...
            <li>
              ...
              deși unele au inclusiv o complexitate avansată, nu sunt lucrările
              mele, ci interfața mea de lucru prin care am intrat în contact cu
              JavaScript, pentru a-l exersa și înțelege. Deși pot explica ce am
              făcut în ele, ideea, arhitectura, logica, prezentarea (inclusiv
              Copyright-ul) nu îmi aparțin.
            </li>
          </ul>
        </div>
        <hr />
